...
class IAlertWorkCompletionInvoice extends Mailable
{
    ...
    public function build()
    {
        ...
        $mailMessage = $this
            ...
            ->view('emails.ialert-work-completion-invoice', $data);
        ...
        if (filter_var($this->data->logistics_email_id, FILTER_VALIDATE_EMAIL)) {
            $cc[] = $this->data->logistics_email_id;
        }
        if ($cc) {
            $mailMessage->cc($cc);
        }
