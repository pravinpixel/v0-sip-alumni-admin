...
export default function EditAnnouncementPage({ params }: { params: { id: string } }) {
  ...
  const [formData, setFormData] = useState({
    title: `Announcement ${params.id}: Annual Meetup 2024`,
    description: `This is the detailed description for announcement ${params.id}. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.`,
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-balance">Edit Announcement</h1>
