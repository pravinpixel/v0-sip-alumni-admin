...
export default function CreateRolePage() {
  ...
  const handlePermissionChange = (moduleKey: string, permissionKey: string, checked: boolean) => {
    setPermissions((prev) => {
      ...
      // If "All" is checked, check all permissions for that module
      ...
      // If "All" is unchecked, uncheck all permissions for that module
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("[v0] Creating role:", { roleId, roleName, permissions })
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-2">Define role details and assign permissions</p>
        </div>
      </div>
