...
<div id="kt_app_header" class="app-header">
  ...
  <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container" style="background-color: white;">
    ...
    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper" style="background-color: white;">
      ...
      <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
          ...
          <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            ...
            style="background-image: url('{{ url('storage/' . Auth::user()->profile_image) ?? '' }}');
            background-size: cover; /* or contain, or a specific size (e.g., 100% 100%) */"
            @else
            src="{{ asset('images/avatar/blank.png') }}"
            @endif>
          </div>
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-item px-3">
              <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="d-flex flex-column">
                  ...
                  <div class="badge badge-light-success fw-bold fs-8 px-2 py-1">{{Auth::user()->role->name ?? ''}}</div>
                </div>
                <!--end::Username-->
              </div>
            </div>
            ...
            <!--begin::Menu item-->
            <div class="menu-item px-5">
              <a class="menu-link px-5 icon_wrapper" href="{{url('logout')}}">Sign Out
