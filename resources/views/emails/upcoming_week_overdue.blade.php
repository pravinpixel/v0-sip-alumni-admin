    ...
    <div class="email-container">
        ...
        <div id="content">
            <div>
                ...
                <p>
                    The below list of tasks assigned to you is on overdue.
                </p>
                <table style="border-collapse: collapse; width: 100%;">
                    ...
                    <tr>
                        <td style="border: 2px solid black;padding: 8px;text-align: left;">{{ $task->assignedby->name ?? 'N/A' }}</td>
                        <td style="border: 2px solid black;padding: 8px;text-align: left;">{{ $task->task_no }}</td>
                        <td style="border: 2px solid black;padding: 8px;text-align: left;">{{ $task->name }}</td>
                        <td style="border: 2px solid black;padding: 8px;text-align: left;">{{ $task->deadline }}</td>
                    </tr>
                    @endforeach
                </table>

                <p>
                  Please make sure the above task is completed as soon as possible.
                </p>
