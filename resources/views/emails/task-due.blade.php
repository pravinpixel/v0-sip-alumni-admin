    ...
    $status = "<span style='color:rgb(146, 56, 81)'><b>DUE</b></span>";
    } elseif ($deadline < $currentDate) {
        $status="<span style='color:rgb(146, 56, 81)'><b>OVERDUE</b></span>" ;
        }
        @endphp
        ...
        <body>
            <div class="email-container">
                ...
                <div id="content">
                    <div>
                        <p>Hi {{$task->assignedto->first_name ?? ''}} {{$task->assignedto->last_name ?? ''}},</p>
                        <p>
                            This task assigned to you is {!! $status !!} today. Please see the task details below.
                        </p>
                        <table style="border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td style="border: 2px solid black;padding: 8px;text-align: left;">{{ $task->due_date_string ??  '' }}</td>
                            </tr>
                            <tr>
                        ...
                        <p class="warning">
                            <i>⚠️ In case this task is not completed by you, please reply to this email with a detailed explanation of
                                the reason and a revised due date to avoid daily reminders from Task Master. The assigner will
                                review and change the due date accordingly.</i>
                        </p>
                        <p>
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="left">
                                        <tr>
                                            <td style="padding: 0; text-align: center;">
                                                <img src="{{ $message->embed($task->signature_logo) }}" alt="{{ config('app.name') }}" style="margin-right: 10px;" />
                                            </td>
