...
@section('content')
    <div>
        ...
        <p><b>Body Subject:</b> <span style='color: #980000;'>Payment follow up for {{ $invoice->invoice_number ?? '' }}.</span>
        </p>

        <p>Dear Customer,</p>
        <p>
            We would like to have feedback on our payment for the invoice below.
        </p>
        ...
        <table style="border-collapse: collapse;">
            ...
            <tr style="background-color:#ffff00">
                <td style="border: 2px solid black;padding: 8px;text-align: left;background-color: #ffff00;"
                    colspan="2"></td>
            </tr>

            <tr>
                <td style="border: 2px solid black;padding: 8px;text-align: left;background-color: #ffff00;">Usha Fire
                    Team Comment:-
                </td>
                <td style="border: 2px solid black;padding: 8px;text-align: left;"><strong
        ...
        <p>We would appreciate an update on the expected payment date. This will help us avoid sending frequent
            reminders. Please let us know at your earliest convenience.</p>
        <br>
