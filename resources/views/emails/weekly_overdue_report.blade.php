    ...
    <div class="email-container">
        ...
        <div id="content">
            <div>
                ...
                <p>
                    Please find the attached overdue task report, which includes a list of pending tasks assigned to you. kindly take a moment to review it and complete the tasks at your earliest convenience.
                </p>
            </div>
        </div>
        <div class="footer">
