...
<div>
    ...
    <p><b>Body Subject:</b> <span style='color: #980000;'>Update required on Bill Accounting Status for Invoice [{{ $invoice->invoice_number ?? '' }}]</span></p>

    <p>Dear Customer,</p>
    <p>
    We are awaiting bill accounting confirmation for the following invoice from your end.
    </p>
...
{{--        </tr>--}}
    ...
    <p style="color: #ff0000;">A confirmation or an update on the expected date for accounting the bill would help us avoid sending frequent email reminders.</p>
</div>
