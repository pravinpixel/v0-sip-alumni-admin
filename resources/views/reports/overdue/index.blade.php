            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{url('reports/overdue')}}" class="text-muted text-hover-primary">Overdue Report</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5 table-responsive"
                                ...
                                <thead>
                                    ...
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th style="min-width: 160px;">Mark Completed At</th>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$task->additional_followers ?? ''}}</td>
...
<script>
    $(document).on('click', '#export', function() {
        ...
        $.ajax({
            url: "{{ route('reports.overdueExport') }}",
            type: 'GET',
            data: pageData,
            xhrFields: {
                responseType: 'blob'
